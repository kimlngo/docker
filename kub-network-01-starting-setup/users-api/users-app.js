...
const app = express();
const AUTH_URL = process.env.AUTH_SERVICE_SERVICE_HOST; //this one is automatically generated by Kubernetes based on the service.yaml. The service name can be used to retrieve the service's IP address as the following formula: <service-name-in-auth-service.yaml-all-caps-replace-dash-with underscore>_SERVICE_HOST
...
app.post('/signup', async (req, res) => {
  ...
  try {
    const hashedPW = await axios.get(
      `http://${AUTH_URL}/hashed-password/` + password
    );
